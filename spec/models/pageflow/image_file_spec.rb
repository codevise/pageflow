...
module Pageflow
  describe ImageFile do
    it 'is invalid if attachment is missing' do
      image_file = build(:image_file, :uploading, attachment_on_s3_file_name: nil)
    ...
    describe 'attachment_styles' do
      it 'includes Pageflow.config.thumbnail_styles' do
        ...
        image_file = build(:image_file, :uploading, attachment_on_s3_file_name: 'image.jpg')
      ...
      it 'turns png file into jpg for non panorama styles' do
        image_file = build(:image_file, :uploading, attachment_on_s3_file_name: 'image.png')
        styles = image_file.attachment_styles(image_file.attachment)
      ...
      it 'turns gif file into jpg for panorama styles' do
        image_file = build(:image_file, :uploading, attachment_on_s3_file_name: 'image.gif')
        styles = image_file.attachment_styles(image_file.attachment)
