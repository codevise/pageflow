  ...
  describe WidgetTypes do
    ...
    describe '#roles' do
      it 'returns uniq list of roles' do
        ...
        widget_types.register(TestWidgetType.new(name: 'some_header', roles: ['navigation', 'header']))
    ...
    describe '#defaults_by_role' do
      it 'returns default widget type for role' do
        widget_types = WidgetTypes.new
        widget_types.register(TestWidgetType.new(name: 'some_navigation', roles: ['navigation']), default: true)
