...
module Pageflow
  describe Configuration do
    ...
    class ConfigTestPageType < PageType
      name 'test'
    ...
    describe '#revision_components' do
      it 'returns all RevisionComponents of registered PageTypes' do
        ...
        conf.register_page_type(ConfigTestPageType.new(:component1))
        conf.register_page_type(ConfigTestPageType.new(:component2))
      ...
      it 'does not return duplicate RevisionComponents' do
        conf = Configuration.new
        conf.register_page_type(ConfigTestPageType.new(:component1))
        conf.register_page_type(ConfigTestPageType.new(:component1, :component2))
