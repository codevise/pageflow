  ...
  module Policies
    ...
    describe '.entry_creatable' do
      it 'includes all accounts for admins' do
        ...
        expect(Policies::AccountPolicy::Scope.new(user,
                                                  Account).entry_creatable).to include(create(:account))
      end
    ...
    describe '.entry_movable' do
      it 'includes all accounts for admins' do
        ...
        expect(Policies::AccountPolicy::Scope.new(user,
                                                  Account).entry_movable).to include(create(:account))
      end
    ...
    describe '.themings_accessible' do
      it 'includes all accounts for admins' do
        ...
        expect(Policies::AccountPolicy::Scope.new(user,
                                                  Account).themings_accessible).to include(create(:account))
      end
      ...
      it 'includes accounts with memberships with correct user, correct account and ' \
        ...
        expect(Policies::AccountPolicy::Scope.new(user,
                                                  Account).themings_accessible).to include(account)
      end
