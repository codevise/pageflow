    ...
    describe EntryPolicy do
      ...
      describe '.editor_or_above' do
        ...
        it 'includes entries with membership with correct user and correct id' do
          ...
          expect(Policies::EntryPolicy::Scope.new(user, Entry).editor_or_above).to include(entry)
        end
      ...
      describe '.publisher_or_above' do
        it 'includes no entries for admin without memberships' do
          ...
          expect(Policies::EntryPolicy::Scope.new(user, Entry).publisher_or_above).to be_empty
        end
        ...
        it 'includes entries with membership with correct user and correct id' do
          ...
          expect(Policies::EntryPolicy::Scope.new(user, Entry).publisher_or_above).to include(entry)
        end
      ...
      describe '.manager_or_above' do
        it 'includes no entries for admin without memberships' do
          ...
          expect(Policies::EntryPolicy::Scope.new(user, Entry).manager_or_above).to be_empty
        end
        ...
        it 'includes entries with membership with correct user and correct id' do
          ...
          expect(Policies::EntryPolicy::Scope.new(user, Entry).manager_or_above).to include(entry)
        end
