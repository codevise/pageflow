Pageflow.configure do |config|
  ...
  #
  # == Examples
  # config.paperclip_attachments_version = 'v1' (default)
  # config.paperclip_attachments_version = '42'
  ...
  #
  # == Examples
  # config.paperclip_filesystem_root = Rails.public_path.join('system/uploads') # => (default)
  # config.paperclip_filesystem_root = '/tmp/uploads'
  # config.paperclip_filesystem_root = '/mnt/share/uploads'
  ...
  #
  # == Examples
  # config.public_https_mode = :prevent # => redirects https to http (default)
