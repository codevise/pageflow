module Pageflow
  module VideoFilesHelper
    ...
    def poster_image_tag(video_file_perma_id, poster_image_perma_id, options = {})
      video_file = find_file_in_entry(VideoFile, video_file_perma_id)
      poster = find_file_in_entry(ImageFile, poster_image_perma_id)
    ...
    def video_file_video_tag(video_file, options = {})
      ...
      poster = find_file_in_entry(ImageFile, options.delete(:poster_image_id))
      mobile_poster = find_file_in_entry(ImageFile, options.delete(:mobile_poster_image_id))
