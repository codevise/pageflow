...
// `wrapper` option.
export function renderWithReviewState(ui, {commentThreads = [], commentThreadReads = {}, currentUser = null, commentNotificationsMuted = false, drafts, setDraft, seed = {}} = {}) {
  return renderInEntry(ui, {
    seed,
    wrapper: reviewStateWrapper({
      commentThreads, commentThreadReads, currentUser, commentNotificationsMuted, drafts, setDraft
    })
  });
}

// Counterpart for selector hooks that read entry state and review state.
export function renderHookWithReviewState(hook, {commentThreads = [], commentThreadReads = {}, currentUser = null, commentNotificationsMuted = false, drafts, setDraft, seed = {}} = {}) {
...
function reviewStateWrapper({commentThreads = [], commentThreadReads = {}, currentUser = null, commentNotificationsMuted = false, drafts, setDraft} = {}) {
