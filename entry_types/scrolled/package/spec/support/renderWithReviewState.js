...
// `wrapper` option.
export function renderWithReviewState(ui, {commentThreads = [], currentUser = null, drafts, setDraft, seed = {}} = {}) {
  return renderInEntry(ui, {
    seed,
    wrapper: reviewStateWrapper({commentThreads, currentUser, drafts, setDraft})
  });
}

// Counterpart for selector hooks that read entry state and review state.
export function renderHookWithReviewState(hook, {commentThreads = [], currentUser = null, drafts, setDraft, seed = {}} = {}) {
...
function reviewStateWrapper({commentThreads = [], currentUser = null, drafts, setDraft} = {}) {
