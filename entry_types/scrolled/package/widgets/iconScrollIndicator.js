...
function IconScrollIndicator({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: classNames(styles.indicator, styles[`animation-${configuration.animation || 'smallBounce'}`], styles[`size-${configuration.size}`], styles[`align-${getAlignment(configuration, sectionLayout)}`]),
    ref: ref
