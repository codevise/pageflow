import {pageflow} from 'pageflow/sharedFrontend';

export default function createPageflowPlayer(element, {emulateTextTracksDisplay, atmoSettings, mediaContext, playsInline}) {
