...
export default class MediaTag extends React.Component {
  render() {
    return (
      <div className={styles.player_container} ref={element => (this.containerElement = element)}
  ...
  mediaTagHTML() {
    ...
    this.props.sources.forEach(source => {
      ...
      sourceElement.setAttribute('src', "https://staging-cdn-z.pageflow.io/v1/main/pageflow/audio_files/000/000/102/audio.mp3?u=1");
